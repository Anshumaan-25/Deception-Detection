"""SubjectB Stage-2 Pass 2-4 (faithful to process_recording_session): fit baseline on
file_index 0, apply to all, assemble on the global timeline. Mirror of recA_assemble.py.
Run after all cascade shards finish. cwd=deception_detection, absolute spovnob_env python."""
...
print(f"  baseline clip median deviation_magnitude: {base.deviation_magnitude.median():.3f} "
      f"(healthy ~sqrt(n_features); 0 = degenerate)")
