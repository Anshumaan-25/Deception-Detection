"""SubjectB Stage-2 PRODUCTION cascade (Pass-1 of process_recording_session, parallel shards).
Consumes SPOVNOB rec_subjectB diarization → is_audio_active masks non-target audio.
Mirror of recA_cascade.py. Run cwd=deception_detection, absolute spovnob_env python.
argv = clip base names for this shard (default: all 7)."""
...
DIAR = "/home/user1/Documents/Deception_Detection/audio_diarization/session/rec_subjectB/pipeline_output.json"
CANON = "pipeline_system_outputs/SUBJECTB_SRC/canonical"
OUT = "pipeline_system_outputs"
ALL = ["00_baseline", "01_interview", "02_interview", "03_interview",
       "04_interview", "05_interview", "06_interview"]
CLIPS = sys.argv[1:] or ALL
